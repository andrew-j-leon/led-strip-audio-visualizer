...
from main import create_groups, create_mirrored_groups
...
class TestCreateGroups(TestCase):
    def test_start_led_is_negative(self):
        ...
        with self.assertRaises(ValueError):
            create_groups(START_LED, END_LED, NUMBER_OF_GROUPS)
    ...
    def test_zero_leds(self):
        ...
        self.assertEqual(create_groups(START_LED, END_LED, NUMBER_OF_GROUPS), [])
    ...
    def test_one_led(self):
        ...
        self.assertEqual(create_groups(START_LED, END_LED, NUMBER_OF_GROUPS), EXPECTED)
    ...
    def test_one_group(self):
        ...
        self.assertEqual(create_groups(START_LED, END_LED, NUMBER_OF_GROUPS), [{(0, 100)}])
...
class TestCreateMirroredGroups(TestCase):
    def test_start_led_is_negative(self):
        ...
        with self.assertRaises(ValueError):
            create_mirrored_groups(START_LED, END_LED, NUMBER_OF_GROUPS)
    ...
    def test_zero_leds(self):
        ...
        self.assertEqual(create_mirrored_groups(START_LED, END_LED, NUMBER_OF_GROUPS), [])
    ...
    def test_one_led(self):
        ...
        self.assertEqual(create_mirrored_groups(START_LED, END_LED, NUMBER_OF_GROUPS), EXPECTED)
